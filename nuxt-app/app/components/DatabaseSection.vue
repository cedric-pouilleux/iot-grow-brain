  ...
  <div class="border-t border-gray-100 bg-gray-50 mt-6 rounded-xl overflow-hidden">
    ...
    <div v-if="isOpen" class="p-4 bg-white border-t border-gray-100">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <!-- Actions / Historique -->
        <div
          class="bg-gray-50 rounded-lg p-4 border border-gray-200 flex flex-col justify-center items-center"
        >
          <button
      ...
      <div
        v-if="showMetricsHistory"
        class="mt-4 p-4 bg-white border border-gray-200 rounded-lg animate-fade-in"
      >
        ...
        <div v-else class="h-64 flex items-center justify-center text-gray-400 text-sm">
          <div v-if="isLoadingHistory" class="flex flex-col items-center gap-2">
            <div
              class="animate-spin w-5 h-5 border-2 border-gray-300 border-t-blue-500 rounded-full"
            ></div>
