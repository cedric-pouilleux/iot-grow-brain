      ...
      <div class="mb-3 pt-2 border-t border-gray-700">
        ...
        <div class="space-y-0.5 text-[10px] text-gray-300">
          <div class="flex justify-between">
            <span>1 an (Brut):</span>
            <span class="text-white">{{ localInterval > 0 ? formatSize(calculateStorage(1, false)) : '--' }}</span>
          </div>
          <div class="flex justify-between font-semibold">
            <span>1 an (Comp.):</span>
            <span class="text-white">{{ localInterval > 0 ? formatSize(calculateStorage(1, true)) : '--' }}</span>
          </div>
          <div class="flex justify-between text-gray-400">
            <span>10 ans (Comp.):</span>
            <span class="text-white">{{ localInterval > 0 ? formatSize(calculateStorage(10, true)) : '--' }}</span>
          </div>
        </div>
      </div>
