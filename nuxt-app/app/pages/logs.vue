          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              >
                ...
                <td class="px-4 py-2 text-sm text-gray-900 dark:text-gray-100 relative group">
                  <span class="cursor-help block break-all">{{ log.msg }}</span>
                  <div
                    v-if="log.details && Object.keys(log.details).length > 0"
                    class="absolute left-0 top-full mt-1 hidden group-hover:block z-50 bg-gray-900 text-white text-xs rounded px-3 py-2 max-w-lg shadow-lg border border-gray-700"
                  >
                    <pre class="whitespace-pre-wrap font-mono">{{ formatDetails(log.details) }}</pre>
                  </div>
                </td>
              </tr>
            </tbody>
